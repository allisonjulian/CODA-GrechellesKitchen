...
class ConvertAllDecimalFields < ActiveRecord::Migration
  def up
    ...
    change_column :line_items, :unit_price, :decimal, :precision => 10, :scale => 2, :null => false, :default => 0.0
    change_column :orders, :total, :decimal, :precision => 10, :scale => 2, :null => false
    change_column :orders, :total_bill, :decimal, :precision => 10, :scale => 2, :null => false
  end
  ...
  def down
    ...
    change_column :orders, :total_bill, :decimal
  end
end
